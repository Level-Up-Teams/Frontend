<template>
        ...
        <Toolbar class="mytoolbar">
            ...
            <template #end>
                <div class="card flex justify-content-center">
                    <Dropdown v-model="selectedGame" :options="games" optionLabel="name" placeholder="Select a Game"
    ...
    <div class="card pb-6">
        <Carousel :value="products" :numVisible="3" :numScroll="1" :responsiveOptions="responsiveOptions" circular
            :autoplayInterval="4000" class="mycarousel">
    ...
    <div class="cardcontainer pb-6">
        <Card style="width: 20em" class="card1">
            <template #header>
                <img alt="user header"
                    src="https://lh3.googleusercontent.com/rjB5xzrMuzLuWShz55w2P22s_a-hM46SxjeHWg50HVEYGcOY6yTqTTLBfEXvA0gr1s2goPl8F7LIXgO3_03uidzpC5IirtU6RzglPKoK" />
            </template>
        ...
        <Card style="width: 20em" class="card2">
            ...
            <template #content>
                <p>
                    ...
                    un nuevo y épico campo de batalla multijugador en línea (MOBA) 5 contra 5 desarrollado por TiMi Studio
                    Group!
